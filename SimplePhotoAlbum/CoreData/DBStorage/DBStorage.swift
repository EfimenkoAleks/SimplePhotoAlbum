...
open class DBStorage {
    ...
    open func save(block aBlock: @escaping StorageContextBlock, completion aCompletion: StorageVoidBlock? = nil) {
    ...
    open func defaultContext(block aBlock: @escaping StorageContextBlock) {
    ...
    open func defaultContextAndWait(block aBlock: @escaping StorageContextBlock) {
    ...
    open func clear(completion aCompletion: StorageVoidBlock? = nil) {
    ...
    open func clearAndWait(completion aCompletion: StorageVoidBlock? = nil) {
    ...
    open func clone(object aObject: NSManagedObject, clonePolicy aClonePolicy: ClonePolicy = ClonePolicy.asTemp) -> NSManagedObject? {
